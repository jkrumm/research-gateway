...
const RATES: Record<string, Rate> = {
  ...
  // Not a default here (only reachable via an IU_*_MODEL override). OpenAI's standard
  // short-context rate from developers.openai.com/api/docs/pricing (researched 2026-09-23,
  // not batch/flex/fast). Past 272K input tokens OpenAI bills input x2 / output x1.5 —
  // unreachable under this repo's context guards, so not modelled.
