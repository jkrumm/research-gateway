    ...
    async (span) => {
      ...
      const grounded = await withSpan('research.ground', {}, async (s) => {
        ...
        s.setAttributes({
          ...
          'grounding.citations_degraded': result.grounding.citationsDegraded,
          'grounding.citations_number_unmatched': result.grounding.citationsNumberUnmatched,
      ...
      span.setAttributes({
        ...
        'grounding.citations_degraded': grounded.grounding.citationsDegraded,
        'grounding.citations_number_unmatched': grounded.grounding.citationsNumberUnmatched,
