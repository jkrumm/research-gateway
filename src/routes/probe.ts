...
export const probeRoutes = new Elysia().post(
  ...
  },
  {
    ...
    response: z.object({
      ...
      via: z
        .enum(['raw', 'site-adapter', 'readability', 'lightpanda', 'yt-dlp', 'tavily-extract', 'wayback'])
        .nullable()
      ...
      attempts: z.array(
        z.object({
          step: z.enum(['raw', 'site-adapter', 'readability', 'lightpanda', 'yt-dlp', 'tavily-extract', 'wayback']),
          ok: z.boolean(),
